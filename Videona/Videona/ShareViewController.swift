...
class ShareViewController: UIViewController,ShareInterface , UINavigationBarDelegate{
    
    var output: SharePresenterInterface?
    ...
    func createNavigationBar(){
        ...
        let leftButton =  UIBarButtonItem(title: titleBackButtonBar, style:   UIBarButtonItemStyle.Plain, target: self, action: #selector(ShareViewController.pushBackBarButton(_:)))
