...
//     "Posterize": [.SingleInput:GPUImagePosterizeFilter.init()],
     ...
     "Autumn": [.Blend:GPUImageGrayscaleFilter.init()],
     "Retrotv": [.Blend:GPUImageGrayscaleFilter.init()],
     "Mist": [.Blend:GPUImageGrayscaleFilter.init()],
     "Sunset": [.Blend:GPUImageGrayscaleFilter.init()],
     "Pride": [.Blend:GPUImageGrayscaleFilter.init()],
     ...
     "Wasted": [.Blend:GPUImageGrayscaleFilter.init()],
     "Bokeh": [.Blend:GPUImageGrayscaleFilter.init()],
     "Game": [.Blend:GPUImageGrayscaleFilter.init()],
     "Rain": [.Blend:GPUImageGrayscaleFilter.init()],
     "Dark": [.Blend:GPUImageGrayscaleFilter.init()],
     "Old": [.Blend:GPUImageGrayscaleFilter.init()],
     "Pastel": [.Blend:GPUImageGrayscaleFilter.init()],
     "Stain": [.Blend:GPUImageGrayscaleFilter.init()],
     "Passion": [.Blend:GPUImageGrayscaleFilter.init()],
     "Polaroid": [.Blend:GPUImageGrayscaleFilter.init()],
